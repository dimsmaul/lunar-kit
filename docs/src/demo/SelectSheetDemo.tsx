...
import { SelectSheet, MultiSelectSheet, type SelectOption } from '@/lunar-kit/components/select-sheet'
...
const SelectSheetDemo = () => {
    ...
    return (
        ...
        } code={`import { SelectSheet, MultiSelectSheet } from "@/components/ui/select-sheet"
import React from "react"
